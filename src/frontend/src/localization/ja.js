export default {
    ...
    pages: {
        signup: {
            agree_to_terms:
                '[サインアップ]をクリックすると、読んだことに同意したことになります',
            signup_complete:
        ...
        forgot_password: {
            sub_heading:
                'アカウントを復旧するには、以下にメールアドレスを入力してください。',
            success:
                'パスワードをリセットする方法については、受信トレイを確認してください。',
        },
        reset_password: {
        ...
        activate: {
            ...
            subtitle:
                'アカウントをアクティブ化するためのパスワードを設定します。',
            activated:
                'アカウントが有効になりました。 これで、アカウントにログインできます。',
        },
        dashboard: {
        ...
        not_found: {
            title: 'ページが見つかりません',
            sub_heading:
                'お探しのページは削除されたか、別の場所へ移動した可能性があります。',
        ...
        inquiry: {
            heading: 'お問い合わせ',
            sub_heading:
                'このままお問い合わせされる方は下記のフォームにご入力ください。',
        ...
        about: {
            ...
            activities_description:
                '生計を立てるのに忙しくて、生計を立てることを忘れないでください。',
        },
    },
    menu: {
        home: '家',
