        ...
        <v-row justify="space-around">
            ...
            >
                ...
                >
                    ...
                    <div
                        style="float: left; margin-top: 50px; margin-left: 25px"
                    >
                        <h2>
                            <v-icon
...
export default {
    ...
    computed: {
        ...
        testValid() {
            return (
                this.formData.quantity.some((item) => item !== 0) || 'Required'
            )
        },
    },
    methods: {
        ...
        async handleOrder() {
            try {
                ...
                const isNonZeroItem = this.formData.quantity.some(
                    (item) => item !== 0,
                )
                ...
                const { name, status, menu_id, quantity, total_price } =
                    this.formData
                const customer = {
                    name,
                    status,
